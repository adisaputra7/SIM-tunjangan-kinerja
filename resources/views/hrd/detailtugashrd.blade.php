            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <form role="form" method="POST" action="{{ route('kumpulkanHrd', ['id_tugas'=>$details->idTugas]) }}" enctype="multipart/form-data">
                            <div class="form-group">
                                <label>Pesan</label>
                                <textarea name="pesan" value="" class="form-control" rows="8" 
                                autofocus></textarea>
                            </div>
                            <div class="form-group">
